    ...
    <div class="user-center-content">
      <div class="user-profile-card">
        <div class="user-avatar">
          <a-avatar :size="80" style="background-color: #ff4d4f">
            <template #icon>
              <icon-user />
            </template>
          </a-avatar>
            ...
            >
              <div class="activity-item">
                <div class="activity-content">
                  <icon-link v-if="getActivityIcon(activity.type) === 'link'" />
                  <icon-storage v-else-if="getActivityIcon(activity.type) === 'storage'" />
                  <icon-code v-else-if="getActivityIcon(activity.type) === 'code'" />
                  <icon-history v-else />
